...
public class ThankYouScreen extends LoadingScreen {
	...
	private void initComponent() {
		...
		LabelField textHeaderLabel = new LabelField("THANK YOU", Field.FIELD_HCENTER | Field.FIELD_VCENTER){
			protected void paint(Graphics graphics) {
				// TODO Auto-generated method stub
		...
		LabelField thanksLabel = new LabelField("TERIMA KASIH", Field.FIELD_LEFT | Field.FIELD_VCENTER){
			protected void paint(Graphics graphics) {
				// TODO Auto-generated method stub
				graphics.setColor(Color.WHITE);
				super.paint(graphics);
